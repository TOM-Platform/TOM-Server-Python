...
class VisionClient:
    ...
    def detect_text_image_bytes(self, image_bytes):
        '''
        This method detects text in a image using text detection.
        Parameters
        ----------
        image_bytes: bytes
    ...
    def detect_text_image_file(self, image_path):
        ...
        '''
        return self.detect_text_image_bytes(
            image_utility.read_image_file_bytes(image_path))
    ...
    def detect_dense_text(self, image_path):
        ...
        """
        image = vision.Image(
            content=image_utility.read_image_file_bytes(image_path))
        # pylint: disable=no-member
            ...
            for block in page.blocks:
                ...
                for paragraph in block.paragraphs:
                    ...
                    for word in paragraph.words:
                        ...
                        _logger.info(f'Word text: {word_text} \
    ...
    def detect_objects_texts(self, image_path, is_bytes=False):
        """
        Detects labels in the file.
        Parameters
        ----------
        image_path: str
            The image path to detect labels
        is_bytes: bool
            Whether the image path is in bytes
        """
        if is_bytes:
