...
"""
Returns nothing, stops ALL currently running **services** and 
starts the ONE service with the name as provided in the 'detail' field of the websocket message
"""
class ContextService(BaseComponent):
    ...
    def run(self, raw_data):
        ...
        for component_name, status in all_component_status.items():
            ...
            if component_name.split(":")[0] == "service" and status == base_keys.COMPONENT_IS_RUNNING_STATUS and component_name in exitpoints:
